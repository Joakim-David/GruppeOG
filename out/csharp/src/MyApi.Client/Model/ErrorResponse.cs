...
namespace MyApi.Client.Model
{
    ...
    public partial class ErrorResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="status">HTTP error code</param>
        /// <param name="errorMsg">Error message</param>
        [JsonConstructor]
        public ErrorResponse(Option<int?> status = default, Option<string?> errorMsg = default)
        {
            StatusOption = status;
    ...
    public class ErrorResponseJsonConverter : JsonConverter<ErrorResponse>
    {
        ...
        public override ErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (errorMsg.IsSet && errorMsg.Value == null)
                throw new ArgumentNullException(nameof(errorMsg), "Property is not nullable for class ErrorResponse.");
        ...
        {
            if (errorResponse.ErrorMsgOption.IsSet && errorResponse.ErrorMsg == null)
                throw new ArgumentNullException(nameof(errorResponse.ErrorMsg), "Property is required for class ErrorResponse.");

            if (errorResponse.StatusOption.IsSet)
                writer.WriteNumber("status", errorResponse.StatusOption.Value!.Value);

            if (errorResponse.ErrorMsgOption.IsSet)
                writer.WriteString("error_msg", errorResponse.ErrorMsg);
        }
    }
}
