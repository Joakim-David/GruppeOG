...
inputSpec: /local/swagger3.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{41991D6C-CADB-46A7-806D-56DDD38F7066}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IMinitwitApi>();
            IGetFollowApiResponse apiResponse = await api.GetFollowAsync("todo");
            FollowsResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Minitwit API
- appVersion: 1.0
- appDescription: Minitwit API
