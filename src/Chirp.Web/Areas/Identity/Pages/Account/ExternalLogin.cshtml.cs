    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                {
                    response = await _userManager.AddLoginAsync(user, info); // attach external login
                    if (response.Succeeded)
                    {
                ...
                _logger.LogInformation("User failed to create an account using {Name} provider.", info.LoginProvider);
                return Page();
            }
        }
